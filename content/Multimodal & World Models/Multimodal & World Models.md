...
Everything about perceiving and generating across modalities beyond text — video, 3D space, touch, sound, robotics — and the open question of whether any of it adds up to a model that understands the physical world rather than just pattern-matching its surface.
